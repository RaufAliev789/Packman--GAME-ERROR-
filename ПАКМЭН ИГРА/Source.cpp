...
int main() {
	...
	Texture t;
	t.loadFromFile("C:/Users/wwwra/OneDrive/Рабочий стол/Пакман/Paint/title.png");
	Sprite plat(t);

	Texture yw;
	yw.loadFromFile("C:/Users/wwwra/OneDrive/Рабочий стол/Пакман/Paint/youwin.png");
	Sprite youwin(yw);
	youwin.setPosition(100, 210);

	Texture yl;
	yl.loadFromFile("C:/Users/wwwra/OneDrive/Рабочий стол/Пакман/Paint/youlose.png");
	Sprite youlose(yl);
